...
Versions are derived automatically from git tags via [MinVer](https://github.com/adamralph/minver). See [Releasing](README.md#releasing) for the workflow.
...
- CI publish job that runs on `v*` tag pushes and pushes to nuget.org.
...
- GitHub Actions CI: build, test, pack, upload artifacts on every push and PR.
...
[Unreleased]: https://github.com/encryptedtouhid/NameGuard.ML/compare/v0.1.0...HEAD
